...
Future<Users> editUser(String id,String username, String password, String position,String email) async {
  ...
  try{
    ...
    dio.options.contentType= Headers.formUrlEncodedContentType;
    response = await dio.post("http://192.168.0.181/webDevProjectFlutter/editUser.php"  , data: {"id" : id, "username" : username, "password" : password, "position" : position, "email" : email });
    print(response);
  } catch(e){
    throw (e);
  }
